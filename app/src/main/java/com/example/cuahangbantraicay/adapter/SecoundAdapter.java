...
public class SecoundAdapter extends RecyclerView.Adapter<SecoundAdapter.ViewHolderAdmin>{
    Context mContext;

    public static Boolean isActive = false ;
    List<Order> orderList;

    public SecoundAdapter(Context mContext,   List<Order> orderList) {
    ...
    @NonNull
    @Override
    public SecoundAdapter.ViewHolderAdmin onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_row_secound, parent, false);
        SecoundAdapter.ViewHolderAdmin viewHolderAdmin = new SecoundAdapter.ViewHolderAdmin(view);
...
//        private ImageView ivAccept,ivCancle;
        public ViewHolderAdmin(@NonNull View itemView) {
            super(itemView);
            diachi = itemView.findViewById(R.id.addressOrder2);
            idkhach = itemView.findViewById(R.id.useridOrder2);
            idorder = itemView.findViewById(R.id.orderId2);
