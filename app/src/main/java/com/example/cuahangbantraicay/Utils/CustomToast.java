...
public class CustomToast extends Toast {
    ...
    public static Toast makeText(Context context, String message, int duration, int type, boolean androidicon) {
        ...
        if (type == 1) {
            ...
            img.setImageResource(R.drawable.baseline_beenhere_24);
        } else if (type == 2) {
            linearLayout.setBackgroundResource(R.drawable.warning_shape);
            img.setImageResource(R.drawable.baseline_back_hand_24);
        } else if (type == 3) {
            linearLayout.setBackgroundResource(R.drawable.error_shape);
            img.setImageResource(R.drawable.baseline_close_24);
        } else if (type == 4) {
            linearLayout.setBackgroundResource(R.drawable.confusing_shape);
            img.setImageResource(R.drawable.baseline_settings_backup_restore_24);
        }
