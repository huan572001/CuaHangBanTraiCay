...
public class ManagerProductDetail extends AppCompatActivity {
    ...
    private void initCategory() {
        try {
            CategoryApi.getCategory(getApplicationContext(), BASE_URL.BASE_ADMIN_URL + "all-category", new VolleyCallback1() {
                @Override
...
//                        System.out.println(categoryTmp);
    ...
    private void setData() {
        ...
        edtDiscount.setText(String.valueOf(product.getDiscout()));
...
//        System.out.println(product.getImage());
        ...
        product.setDiscout(Integer.parseInt(String.valueOf(edtDiscount.getText())));
