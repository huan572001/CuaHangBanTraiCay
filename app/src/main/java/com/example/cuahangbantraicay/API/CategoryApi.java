...
public class CategoryApi {
    public static void getCategory(Context context, String url, VolleyCallback1 callback) throws JarException {
...
//                        System.out.println("Nam : " + response);
    ...
    public static void createCategory(Context context, String url, Category category, VolleyCallback1 callback) throws JSONException {
        RequestQueue requestQueue = Volley.newRequestQueue(context);
    ...
    public static void CategoryDelete(Context context, String url, VolleyCallback1 callback) throws JSONException {
        RequestQueue requestQueue = Volley.newRequestQueue(context);
...
//        requestBody.put("category", idCategory);
    ...
    public static void CategoryUpdate(Context context, String url, Category category, VolleyCallback1 callBack) throws JSONException {
        RequestQueue requestQueue = Volley.newRequestQueue(context);
